  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 231, 185, 224)),
          ),
        home: MyHomePage(),
      ),
    );
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Text('Una palabra grandiosa al azar:'),
            BigCard(pair: pair), 
            //Agregamos un boton 
            ElevatedButton(
              onPressed: () {
...
class BigCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final style = theme.textTheme.displayMedium!.copyWith( //tema de texto
